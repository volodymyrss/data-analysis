...
class TestDDOSA(unittest.TestCase): 
    ...
    def test_rundda_writecache(self):
        os.system("INTEGRAL_DDCACHE_ROOT=./ddcache rundda.py ii_skyimage -v -m ddosa -m /onlybright/v4 -m /imagebin2580/v1 -a 'ddosa.ScWData(input_scwid=\"066500120010.001\")'")
        import pyfits
